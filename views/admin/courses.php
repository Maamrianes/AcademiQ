            ...
            <div class="card-body">
                <?php if ($edit): ?>
                    <form method="post" class="vstack gap-3">
                        ...
                        <div>
                            ...
                            <input class="form-control" type="number" min="0" max="5" step="1" name="credits" value="<?= e((string) $edit['credits']) ?>" required>
                        </div>
                ...
                <?php else: ?>
                    <form method="post" class="vstack gap-3">
                        ...
                        <div>
                            <label class="form-label">Credits</label>
                            <input class="form-control" type="number" step="1" min="1" max="5" name="credits" value="3" required>
                        </div>
